...
이 비교 축을 통해 **"각 기업이 서로 다른 기술로 저전력이라는 동일한 목적을 달성하려 한다"** 는 결론에 도달했고, 이는 프로젝트가 출발점으로 삼았던 "저전력이 웨어러블 기기의 핵심 설계 제약"이라는 배경 주장을 데이터로 뒷받침하는 근거가 되었다.

발표 후 질의응답에서 교수님께서 **"기업별 기술을 구체적으로 어떻게 비교했는가"** 를 물으셨다. 이에 대해 각 회사의 **최신 웨어러블 기기(스마트워치)의 공개 스펙을 확인하고, 관련 기술 아티클을 근거로 대조하는 방식으로 비교했다** 고 답변했다. 제품이라는 구체적 결과물의 실제 사양에서 출발해 그 배경 기술을 문헌으로 뒷받침하는 접근이었기에, 비교의 근거를 명확히 제시할 수 있었다. 발표 내용 자체가 아니라 **"자료를 어떻게 수집했는지"** 를 구체적으로 되물으셨다는 점에서, 비교 결과가 청중에게 그만큼 설득력 있게 전달되었음을 확인할 수 있었다.
